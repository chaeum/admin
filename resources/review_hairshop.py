...
def fetch_list_summary(hairshop_id):
    conn = cnx_pool.get_connection()
    cursor = conn.cursor()
...
class ReviewHairshop(Resource):
    ...
    def get(self):
        ...
        result, review = fetch_list(hairshop_id)
        count, score = fetch_list_summary(hairshop_id)
